                    ...
                    <div className="modal-dialog ">
                        <div className="modal-content overflow-hidden rounded-3">
                            <div className="position-relative">
                                ...
                                <button type="button" className="btn-close position-absolute end-0 m-2 bg-dark text-white d-flex justify-content-center align-items-center font-weight-bold" style={{ zIndex: '9999' }} data-bs-dismiss="modal" aria-label="Close">x</button>
                            </div>
