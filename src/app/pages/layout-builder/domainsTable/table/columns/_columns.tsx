...
const usersColumns: ReadonlyArray<Column<Domain>> = [
  ...
  {
    Header: (props) => (
      <DomainCustomHeader tableProps={props} title='Installation' className='min-w-125px' />
    ),
    id: 'last_login',
    Cell: ({...props}) => <DomainLastLoginCell last_login={props.data[props.row.index].last_login} />,
  },
  {
    Header: (props) => <DomainCustomHeader tableProps={props} title='Access' className='min-w-125px' />,
    accessor: 'role',
  },
  {
    Header: (props) => (
